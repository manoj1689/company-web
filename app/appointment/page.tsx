...
<img src="logo.png" alt="EramLabs Logo" className="h-8" />
</div>
<nav className="hidden md:flex space-x-8">
  ...
  <a href="#testimonial" className="text-gray-600 hover:text-gray-900">Testimonial</a>
  <a href="#contact" className="text-gray-600 hover:text-gray-900">Contact</a>
  <a href="#careers" className="text-gray-600 hover:text-gray-900">Careers</a>
</nav>

<button className="bg-pink-500 text-white px-4 py-2 rounded-full hover:bg-pink-600 transition-colors !rounded-button whitespace-nowrap cursor-pointer">
Contact Us
</button>
</div>
</header>
