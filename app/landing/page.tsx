      ...
      < GetInTouchSection/>
         ...
         <div className="fixed left-0 top-1/2 transform -translate-y-1/2 z-50">
          <div className="flex flex-col space-y-4">
            {/* Book a Meeting */}
            <div className="rounded-r-md w-12 h-16 md:h-40 bg-blue-400 shadow-lg border- border-gray-100 flex items-center justify-center relative floating-sidebar">
              <button
                onClick={() => router.push("/appointment")}
                className="transform -rotate-90 px-2 py-3 flex items-center space-x-2 text-white  bg-blue-400 hover:bg-blue-800 hover:rounded-r-md hover:scale-110 transition-all duration-300 ease-in-out whitespace-nowrap cursor-pointer"
