...
function OurTeam() {
  ...
  const teamMembers = [
    { name: "David Miller", role: "Chief Executive Officer", img: "/career/team1.jpg" },
    { name: "Emily Zhang", role: "Chief Technical Officer", img: "/career/team.jpg" },
    { name: "Alexa John", role: "Chief Operating Officer", img: "/career/lifeat.jpg" },
    { name: "Jonathan Craig", role: "Chief Strategy Officer", img: "/career/team2.jpg" },
  ];
      ...
      <div className="container mx-auto text-center relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          {teamMembers.map((member, index) => (
            ...
            >
              <img
                src={member.img}  // Ensure images are placed in /public/landing/team/
                alt={member.name}
