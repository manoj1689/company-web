...
export default function Footer() {
  ...
  return (
    <footer className="bg-white  px-4 sm:px-6 lg:px-16 text-gray-700 relative">
      <div
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4 ">
            <div>
              ...
              >
                <img onClick={()=>handlenavigation('/landing')} src="/logo/logo.png" alt="" />
              </Link>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <p>
                <FaLinkedin className=" hover:text-blue-400" size={25} />
              </p>{" "}
              <p>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <p onClick={()=>handlenavigation('/about')} className="block text-gray-600 hover:text-gray-900 transition-colors">
                About Us
              </p>
              <p onClick={()=>handlenavigation('/services')} className="block text-gray-600 hover:text-gray-900 transition-colors">
                Service
              </p>
              <p onClick={()=>handlenavigation('/careers')} className="block text-gray-600 hover:text-gray-900 transition-colors">
                Careers
              </p>
            </div>
          </div>
